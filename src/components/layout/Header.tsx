    ...
    <header className="h-16 border-b border-[var(--border-color)] flex items-center justify-between px-4 bg-[var(--bg-panel)] shrink-0 z-40 shadow-md relative">
        ...
        <div className="flex flex-col items-center justify-center flex-1">
            <div className="flex items-center gap-4">
                ...
                <div className="bg-[var(--bg-element)] rounded-full px-3 py-2 flex items-center gap-3 border border-[var(--border-color)] shadow-xl">
                    ...
                    <button onClick={() => togglePlay()} className={`w-10 h-10 rounded-full flex items-center justify-center transition-all border ${audioState.isPlaying ? 'bg-[var(--accent)] text-black border-white shadow-[0_0_15px_rgba(234,179,8,0.4)]' : 'bg-[var(--bg-panel)] text-[var(--text-main)] hover:bg-[var(--bg-main)] border-[var(--border-color)]'}`}>
        ...
        <div className="flex items-center gap-3 justify-end w-auto md:w-1/4">
            ...
            <div className="hidden md:flex items-center gap-2">
                ...
                <button onClick={toggleFullScreen} className="p-2 hover:bg-[var(--bg-element)] rounded text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors" title="Tela Cheia">
            ...
            {setIsCompositionOpen && (
                <button 
                    ...
                    title="Assistente de Composição"
                >
